// Compares this port against the JavaScript detector it came from, on a cached
// corpus that is not in this repository, so the suite SKIPS itself unless
// SLOPMETER_PARITY_ROOT points at a checkout of it. A clone needs neither.
